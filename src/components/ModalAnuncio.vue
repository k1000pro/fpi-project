...
<template>
  <div class="q-pa-none">
    ...
    <q-item
      clickable
      v-ripple
      class="text-weight-bold lt-md q-pa-lg "
      @click="dialog = true"
    >
          ...
          >
              ...
              <div class="row justify-star q-mx-xl">
                ...
                <div class="col-12 col-sm-9">
                  <q-input
                    ...
                    prefix="Marca:"
                    v-model="marca"
                    label="Marca del Telefono *"
                    :dense="dense"
                    lazy-rules
                    filled
                    :rules="[
                      (val) =>
                        (val && val.length > 0) || 'Por favor rellene el campo',
                    ]"
                  />
                  <q-input
                    standout="bg-primary text-white"
                  ...
                  <q-select
                    ...
                    :dense="dense"
                    lazy-rules
                    :rules="[(val) => val || 'Por favor rellene el campo']"
                    filled
                  />
                  <q-input
                    standout="bg-primary text-white"
            ...
            <div class="col-12 col-sm-5 flex">
              <div class="row justify-star q-mx-xl q-mb-md">
                <span class="text-subtitle1 col-12"
                  >Titulo breve del anuncio</span
                >
                <q-input
                  class="col-12"
                  standout="bg-primary text-white"
              ...
              <div class="row flex justify-center">
                <div class="q-pa-md col-8">
                  <q-file
                    ...
                    :rules="[
                      (val) =>
                        (val && val.length > 0) || 'Seleccione las imagenes',
                    ]"
...
export default {
  setup() {
    ...
    return {
      ...
      limpiarFotos() {
        (fotosURL.value = []), (fotos.value = null);
      },
    };
  },
};
